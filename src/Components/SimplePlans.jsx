...
const SimplePlans = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b  px-[3%] py-[8%] lg:mt-[5%] relative">
       <div className="absolute inset-0 z-0">
        <div className="absolute top-[-6%] left-[40%] w-[37.5rem] h-[31.25rem] bg-pink-500 rounded-full opacity-14 blur-3xl" />
  
        

      </div>
      {/* Heading */}
      <div className="text-center text-white mb-[4%] relative">
        <h2 className="text-3xl text-white md:text-4xl font-spaceGrotesk mb-[1%] relative">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-stretch justify-center relative">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-[30%] left-[12.5%]  w-[37.5rem] h-[31.25rem] bg-pink-500 rounded-full opacity-15 blur-3xl" />
        </div>
